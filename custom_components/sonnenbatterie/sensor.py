...
class SonnenBatterieConfigFlow(config_entries.ConfigFlow, config_entries.OptionsFlowWithConfigEntry):
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional("scan_interval", default=DEFAULT_SCAN_INTERVAL): vol.All(vol.Coerce(int), vol.Range(min=MIN_SCAN_INTERVAL)),
    ...
    def async_get_options_flow(config_entry):
        flow = SonnenBatterieConfigFlow()
        flow.entry = config_entry
        return flow